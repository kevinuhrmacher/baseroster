"""
Django settings for baseroster project.
...
ROOT_URLCONF = 'baseroster.urls'

WSGI_APPLICATION = 'baseroster.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'baseroster.db'),
    },
}
